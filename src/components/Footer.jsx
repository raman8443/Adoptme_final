    ...
    >
      <div className="max-w-screen-xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[white] text-sm">
              Dando un hogar a quienes más lo necesitan{" "}
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-6">
          ...
          <Link to="/nuestra-mision" className="hover:text-[white] transition">
            Nuestra Misión
          </Link>
          <Link to="/como-adoptar" className="hover:text-[white] transition">
            Cómo Adoptar
          </Link>
