        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow p-6">
            <h3 className="text-2xl font-semibold mb-2">
              1. Explora nuestras publicaciones
            </h3>
            <p>
              Revisa las mascotas disponibles en la sección{" "}
              <strong>“Mascotas”</strong>. Puedes ver fotos, leer descripciones
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <p>
              ...
              <ul className="list-disc list-inside mt-2">
                ...
                <li>
                  Puedes contactarnos si lo prefieres y nosotros gestionamos tu
                  solicitud.
                </li>
                <li>
                  También puedes comenzar el proceso directamente desde el
                  Sitio.
                </li>
              </ul>
            </p>
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <p>
              Una vez encuentres la mascota ideal, envíanos un mensaje o inicia
              el proceso desde el enlace que encontrarás junto a cada
              publicación.
            </p>
          </div>
          ...
          <div className="bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded-xl mt-8">
            ...
            <p>
              No aceptamos entregas de mascotas con hogar, ni casos donde el
              motivo sea su mala conducta. Adoptar es un compromiso de por vida:
              asegúrate de estar listo para asumirlo con amor y responsabilidad.
            </p>
          </div>
        </div>
      </div>
